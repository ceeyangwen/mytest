	...
	<body>
		...
		<div class="book">
			...
			<div id="left" class="book_left">
				<s:include value="/main/category.action"></s:include>
			</div>
			<!--左栏结束-->
			...
			<div class="book_center">
				...
				<s:include value="/main/recommend.action"></s:include>
				</div>
				...
				<s:include value="/main/hot.action"></s:include>
				</div>
				<!--热销图书结束-->

				<!--最新上架图书开始-->
				<div class="book_c_border2" id="new">
				<s:include value="/main/findNewPros.action?topSize=4"></s:include>
				</div>
