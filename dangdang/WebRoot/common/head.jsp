...
<link href="../css/book_head.css" rel="stylesheet" type="text/css">
	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text">
				...
				|<a href="#" name="helpcenter" class="head_black12a" target="_black">帮助</a>
				|</span>
			</span>
		...
		<s:if test="#session.user==null">
			[&nbsp;<a href="../user/login_form.jsp" class="b">退出</a>&nbsp;]
